...
## chrlist thoughts
# - unix one-liner to get from multiple files:
# use sort on glob to sort files by ID, then grep fasta IDs into file
# create python fn to read as list from single file of IDs
# pass as additional input
# throw error if passed without --pbsim?
